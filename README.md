...
🖥️ How It Works
Allow Microphone Access: The system listens for high-pitch scream frequencies.
Detection: Once a scream or loud noise is detected, the system triggers an alert.
Emergency Response: SOS and panic alarms are activated instantly.
Face Recognition: Confirms identity and helps avoid false alerts.
Daily Check-in: Ensures user safety through scheduled prompts.
🚀 Installation & Setup
